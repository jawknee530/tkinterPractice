...
mainWindow.columnconfigure(4, weight=6)
...
for zone in os.listdir('/usr/bin'):
    fileList.insert(tkinter.END, zone) # insert to the END of the list
...
optionFrame = tkinter.LabelFrame(mainWindow, text="Field Detalis")
...
cancelButton = tkinter.Button(mainWindow, text="Cancel", command=mainWindow.quit) # don't use a () when assigning a command
